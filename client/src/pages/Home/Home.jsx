...
<div>
      ...
      <p style={{ paddingBottom: "100px" }}>
        ...
        looking for a relaxing manicure, a stunning pedicure, or intricate nail
        art, we've got you covered.
      </p>
      </div>
      ...
      <section style={textImage}>
        ...
        <div>
          ...
          <p style={{ ...smallParagraph, paddingBottom: "100px" }}>
            We use only the highest quality nail products and polishes to pamper
            your nails. Your safety and satisfaction are our top priorities.
          </p>
        </div>
      </section>
      </div>
      <div style={containerStyle}>
      <h2 style={headerText}>Our Services</h2>
      <div style={{ ...textImage }}>
        <div style={{ padding: "20px" }}>
          <h3 style={pinkHeaderStyle}>Manicures</h3>
          <p>
            Treat your hands to a rejuvenating manicure that leaves your nails
            looking flawless. Choose from a variety of nail shapes, colors, and
            designs to express your unique style.
          </p>
          <>
            <img
              src={serviceImage}
              alt="French tips manicure"
              style={{ ...medImageStyle, paddingBottom: "100px" }}
            />
          </>
        </div>
        <div style={{ padding: "20px" }}>
          ...
          <p>
            Pamper your feet with a relaxing pedicure that includes exfoliation,
            nail shaping, and the perfect polish. Feel refreshed from heel to
            toe.
          </p>
          <img
            src={pedicure}
        ...
        <div style={{ padding: "20px" }}>
          ...
          <img src={nailArt} alt="Creative nail design" style={medImageStyle} />
        </div>
      </div>
      </div>
      <section style={containerStyle}>
        ...
        <p style={{ paddingBottom: "100px" }}>
          ...
          <br></br>
          <p style={pinkHeaderStyle}>See you soon! - xoxo</p>
        </p>
      </section>
      </div>
  );
